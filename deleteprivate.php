...
<body style="background:skyblue">
            ...
            <nav class="navbar navbar-danger " style="background-color:rgb(71, 129, 236);">
             <form class="form-inline" style="margin-top:0px;" method="post" action="deleteprivate.php">
               <a class="navbar-brand" href="admindash.php"><img src="img/logo2.jpg" style="height:70px;width:170px"> </a>
               <input class="form-control mr-sm-2 Hinput" style="width:500px;" type="search" placeholder="Search And Delete Private Jobs By Title" aria-label="Search" name="pname">
            ...
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Name</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Job Category</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Job Description</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Job Quantity</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Dept</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Image</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Select Type</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Title</th>
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:yellow;">Delete</th>
                  ...
                  <?php
                      if(isset($_POST['submit'])){
                        ...
                        $date=$_POST['pname'];
                        $qry="select * from postjobprivate where title='$date'";
                        $run=mysqli_query($db,$qry);
                        if(mysqli_num_rows($run)<1){
                            echo "<tr><td colspan='10' style='border:1px solid black;padding:10px;text-align:center;background-color:skyblue;'>No Job Found<td></tr>";
                        }
                        else{
                            while($data=mysqli_fetch_assoc($run)){
                              ...
                              <tr>
                                 ...
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><a href="deleteprivatedata.php?pid=<?php echo $data['Id']?>">Delete</a></td>
                              </tr>
                              <?php
                            }
                        }
