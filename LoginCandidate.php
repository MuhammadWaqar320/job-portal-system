	...
	<section class="container-fluid" style="margin-bottom:60px;margin-top:60px;">
		...
		<section class="row justify-content-center">
		  <section class="col-12 col-sm-6 col-md-4">
			<form class="form-container" action="LoginCandidatePHP.php" method="post" class="Form">
			<div class="form-group">
			  <h4 class="text-center font-weight-bold">Candidate Login Form </h4>
			  <label for="InputName1">Username</label>
			   <input type="text" class="form-control" id="InputComName" aria-describeby="nameHelp" placeholder="Enter  Name" name="ComName" required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
			  ...
			  <input type="text" style="display:none" class="form-control" id="InputPassword1" placeholder="Job title is selected" name="id" value="<?php echo $Id ?>"required >
			</div>

			<button type="submit" class="btn btn-primary btn-block" name="submit">Submit</button>
			<div class="form-footer">
			  <p> Don't have an account? <a href="RegisCandidate.php">Sign Up</a></p>
