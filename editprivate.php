    ...
    <nav class="navbar navbar-danger " style="background-color:rgb(39, 171, 211)">
            ...
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;">Edit</th>
                  ...
                  <?php
                        ...
                        $con=mysqli_connect('localhost','root','','smajobberoslo');
                        $qry="select * from postjobprivate";
                        ...
                        if(mysqli_num_rows($run)<1){
                            ...
                            while($data=mysqli_fetch_assoc($run)){
                              ...
                              <tr>
                                 ...
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><a href="editpriform.php?pid=<?php echo $data['Id']?>">Edit</a></td>
                              </tr>
                              <?php
                            }
                        }
