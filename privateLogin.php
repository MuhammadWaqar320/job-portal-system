...
if (isset($_POST['submit'])) {
  ...
  $user_check_query = "SELECT * FROM person WHERE name='$username' AND password='$password'";
	...
	<section class="container-fluid" style="margin-bottom:60px;margin-top:60px;">
		...
		<section class="row justify-content-center">
		  <section class="col-12 col-sm-6 col-md-4">
			<form class="form-container" action="privateLogin.php" method="post" class="Form" name="LoginPage">
			...
			<div class="form-footer">
			  <p> Don't have an account? <a href="privateRegis.php">Sign Up</a></p>
