...
<div class=container>
 <div class="row" style="background:yellowgreen;margin-top:200px;padding:100px;border:1px solid red;border-radius:10px;font-family:initial;">
    <div class="col-sm-6">
 <center>  <a class="btn btn-danger" style="font-weight:bold;font-size:25px" href="assignmentForm.php">Post a Assignment</a></center> 
    </div>
    <div class="col-sm-6">
    <center>  <a class="btn btn-danger" style="font-weight:bold;font-size:25px;padding-left:55px;padding-right:55px;" href="Postjob.php">Post a Job</a></center> 
    </div>
    <div>
    </div>
</div>
