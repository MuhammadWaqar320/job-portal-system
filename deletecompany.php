...
<body style="background:skyblue">
            ...
            <nav class="navbar navbar-danger " style="background-color:rgb(71, 129, 236);">
             <form class="form-inline" style="margin-top:0px;" method="post" action="deletecompany.php">
               <a class="navbar-brand" href="admindash.php"><img src="img/logo2.jpg" style="height:70px;width:170px"> </a>
               <input class="form-control mr-sm-2 Hinput" style="width:500px;" type="search" placeholder="Search And Delete Company Jobs By Title" aria-label="Search" name="pname">
                        ...
                        if(mysqli_num_rows($run)<1){
                            ...
                            while($data=mysqli_fetch_assoc($run)){
                              ...
                              <tr>
                                 ...
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><a href="deletecomdata.php?pid=<?php echo $data['Id']?>">Delete</a></td>
                              </tr>
                              <?php
                            }
                        }
