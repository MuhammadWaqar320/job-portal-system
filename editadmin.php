            ...
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;">Edit</th>
                  ...
                  <?php
                        ...
                        if(mysqli_num_rows($run)<1){
                              echo "<tr><td colspan='4' style='border:1px solid black;padding:10px;text-align:center;background-color:skyblue;'>No Record Found<td></tr>";
                            ...
                            while($data=mysqli_fetch_assoc($run)){
                              ...
                              <tr>
                                 ...
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><?php echo $data['admin_name']; ?></td>
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><?php echo $data['admin_password']; ?></td>
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><a href="editadminform.php?pid=<?php echo $data['Id']?>">Edit</a></td>
                              </tr>
                              <?php
                            }
                        }
