...
<body class="Regis" style="background-color:skyblue;">
            ...
            <nav class="navbar navbar-danger " style="background-color:rgb(39, 171, 211)">
             <form class="form-inline" style="margin-top:15px;">
                ...
                <a class="btn btn-outline-light" style="background-color:blue;border-radius:8px;margin-left:10px;" href="editcompany.php" role="button" >Backward</a>
                </form>
              </nav>
...
<?php
        ...
        $pid=$_GET['pid'];
        $sql="SELECT * FROM postjob WHERE Id='$pid'";
...
?>
             ...
             <form method="post" action="editcomdata.php" enctype="multipart/form-data">
                  <h4>Id</h4>
