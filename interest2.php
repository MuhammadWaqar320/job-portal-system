...
$Id = $_GET['Id'];
$interest=0;
$query="SELECT * from interest2 where job_id='$Id'";
...
$applyid=$applyid+1;
$query = "INSERT INTO interest2(Id,interest_var,job_id) 
VALUES('$applyid','$interest','$Id')";
mysqli_query($db, $query);
$user_check_query = "SELECT * FROM postjobprivate WHERE Id='$Id'";
