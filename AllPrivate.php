...
<body style="background-color:skyblue">
            ...
            <nav class="navbar navbar-danger " style="background-color:rgb(39, 171, 211)">
                <a class="btn btn-outline-light" style="background-color:blue;border-radius:8px; margin-left:525px;" href="Logout.php" role="button" >Logout</a>
            ...
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;">Phone</th>
            ...
            <th style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;">Password</th>
                  ...
                  <?php
                        ...
                        if(mysqli_num_rows($run)<1){
                            echo "<tr><td colspan='5' style='border:1px solid black;padding:10px;text-align:center;background-color:skyblue;'>No Private Person Found<td></tr>";
                        }
                        else{
                            while($data=mysqli_fetch_assoc($run)){
                              ...
                              <tr>
                                 ...
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><?php echo $data['name']; ?></td>
                                 <td style="border:1px solid black;padding:10px;text-align:center;background-color:skyblue;"><?php echo $data['phone']; ?></td>
