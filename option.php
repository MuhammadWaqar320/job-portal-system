...
<div class=container>
 <div class="row" class="hire" style="background:skyblue;margin-top:200px;padding:100px;border:1px solid red;border-radius:10px;font-family:initial;">
    <div class="col-sm-6">
 <center>  <a class="btn hire" style="background-color:blue;color:white; font-weight:bold;font-size:25px" href="privateLogin.php">Login As a Private Person</a></center> 
    </div>
    <div class="col-sm-6">
    <center>  <a class="btn lc hire" style="background-color:blue;color:white;font-weight:bold;font-size:25px;padding-left:10px;padding-right:10px;" href="LoginPage.php">Login As a Company</a></center> 
    </div>
    <div>
    </div>
</div>
