...
<body class="Regis" style="background-color:skyblue;">
            ...
            <nav class="navbar navbar-danger " style="background-color:rgb(39, 171, 211)">
             <form class="form-inline" style="margin-top:15px;">
                ...
                <a class="btn btn-outline-light" style="background-color:blue;border-radius:8px;margin-left:10px;" href="editprivate.php" role="button" >Backward</a>
                </form>
              </nav>
...
<?php
        ...
        $pid=$_GET['pid'];
        $sql="SELECT * FROM postjobprivate WHERE Id='$pid'";
...
?>
             ...
             <form method="post" action="editpridata.php" enctype="multipart/form-data">
                  <h4>Id</h4>
                  <input type="text" name="pname" class="pro" value=<?php echo $data['Id']; ?>>
                  <h4>Name</h4>
                  <input type="text" name="pprice" class="pro" value=<?php echo $data['Company_name']; ?>>
                  <h4>Job Description</h4>
                  <input type="text" name="pcategory" class="pro" value=<?php echo $data['job_description']; ?>>
